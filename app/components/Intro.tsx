...
const Intro = () => {
  return (
    ...
    <p className='text-6xl my-9 font-serif'>Hello0!</p>
    ...
    <div>With a keen interest in website development, I embrace the challenge of crafting digital experiences that captivate and engage users.</div> 
    </div>
